//! SSD1680(Z) E-Paper Display Controller implementation.
...
/// Display refresh operating mode for the SSD1680 controller.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub enum Ssd1680RefreshMode {
...
/// SSD1680(Z) Controller IC driver configuration.
#[derive(Debug, Clone, Copy)]
pub struct Ssd1680Controller {
    width: u32,
    height: u32,
    refresh_mode: Ssd1680RefreshMode,
}

impl Ssd1680Controller {
    /// Creates a new SSD1680 controller configured for target dimensions.
    pub fn new(width: u32, height: u32) -> Self {
        Self {
            width,
            height,
            refresh_mode: Ssd1680RefreshMode::default(),
        }
    }

    /// Sets display refresh operating mode (builder method).
    pub fn with_refresh_mode(mut self, mode: Ssd1680RefreshMode) -> Self {
        self.refresh_mode = mode;
        self
    }

    /// Sets display refresh operating mode.
    pub fn set_refresh_mode(&mut self, mode: Ssd1680RefreshMode) {
        self.refresh_mode = mode;
    }

    /// Returns current display refresh mode.
    pub fn refresh_mode(&self) -> Ssd1680RefreshMode {
        self.refresh_mode
    }
}
    ...
    BUSY: InputPin,
{
    ...
    fn init_sequence<DELAY: DelayNs>(
        ...
        // Display Update Control 1: RAM content option / source output mode
    ...
    fn trigger_refresh<DELAY: DelayNs>(
        ...
        let mode_byte = match self.refresh_mode {
            Ssd1680RefreshMode::Full => 0xF7,
            Ssd1680RefreshMode::Partial => 0xFC,
        };
